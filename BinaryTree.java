...
public class BinaryTree<E> {
    ...
    public static String preorderString(BinaryTree t) {
        if (t==null) {
            return "";
        } else {
            return "("+t.data+" "+inorderString(t.left)+" "+inorderString(t.right)+")";
        }
    }

    public static String inorderString(BinaryTree t) {
        if (t==null) {
            return "";
        } else {
    ...
    public static String postorderString(BinaryTree t) {
        if (t==null) {
            return "";
        } else {
            return "("+inorderString(t.left)+" "+inorderString(t.right)+" "+t.data+")";
        }
    }
}
